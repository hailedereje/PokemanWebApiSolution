...
{
    /// <inheritdoc />
    public partial class intialPokemanMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PokemanCatagories", x => new { x.PokemanId, x.CatagoryId });
                    table.ForeignKey(
                        name: "FK_PokemanCatagories_Catagories_CatagoryId",
                        column: x => x.CatagoryId,
                        principalTable: "Catagories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PokemanCatagories_Pokemans_PokemanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PokemanCatagories_CatagoryId",
                table: "PokemanCatagories",
                column: "CatagoryId");
